...
import com.nhjclxc.quartztest.test4_linsener.test41_job.Job;
import com.nhjclxc.quartztest.test4_linsener.test41_job.MyGlobalJobLinsener;
import com.nhjclxc.quartztest.test4_linsener.test41_job.MyJobLinsener;
import org.quartz.*;
...
public class Test {
    ...
    public static void main(String[] args) throws SchedulerException {
        ...
        JobDetail job = newJob(Test42TriggerJob.class) // HelloJob是一个任务实列对象
        ...
        // 创建并注册一个局部job监听器
        scheduler.getListenerManager().addTriggerListener(new MyTriggerLinsener(), EverythingMatcher.allTriggers());
